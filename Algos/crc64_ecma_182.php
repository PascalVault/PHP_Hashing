...
class HasherCRC64_ecma_182 extends HasherBase
{
	protected $FHash;
	...
	public function Update($Msg, $Length)
	{
		for ($i=0; $i<$Length; $i++)
		{
			$Index = xor64(shr64($this->FHash, 56), ord($Msg[$i]));
			$Index = and64($Index, 0xFF);
			$Index = 1*gmp_strval($Index);
			
			$this->FHash = xor64(shl64($this->FHash, 8), $this->Table[$Index]);
		}   
	}
...
$HasherList->RegisterHasher('CRC-64 ecma 182', 'HasherCRC64_ecma_182');
