...
class HasherCRC64_xz extends HasherBase
{
	protected $FHash;
	...
	{
		$this->FHash = xor64($this->FHash, '0xFFFFFFFFFFFFFFFF');
		return strtoupper(gmp_strval($this->FHash, 16)); 
	}
}

$HasherList->RegisterHasher('CRC-64 xz', 'HasherCRC64_xz');
